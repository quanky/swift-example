...
/** This event is fired every time a server-side Extension sends a message, usually in response to an ExtensionRequest. 
 ...
 @param params (SFSObject *) custom parameters
 @param room (id<Room>) the Room which the Extension is attached to (for Room Extensions only)
...
/** This event is fired in response to a SetRoomVariablesRequest
 ...
 @param room (SFSRoom *) the Room in which the event occurred (Since API 1.7.x)
 @param changedVars (NSArray *) the list of variable names that where modified or created
 @param sourceRoom (NSNumber *) The id of the Room which the Extension is attached to (for Room Extensions only),
