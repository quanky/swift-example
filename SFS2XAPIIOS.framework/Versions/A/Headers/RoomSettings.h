...
/**
 When switched off allows any user in the Room to invite more players. When switched on, allows only the Room's owner
 to invite other people inside.
 */
@property (assign) BOOL allowOwnerOnlyInvitation; // New in SFS2X 2.12, API 1.7
